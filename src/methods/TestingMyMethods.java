...
public class TestingMyMethods {
    public static void main(String[] args) {
        ...
        System.out.println(MyMethods.MaxOf4(num1, num2, num3, num4));

        // write a program which is finding the abs difference between max and
        //(num1)

        Math.abs(Math.max(Math.max(Math.max(num1, num2),num3),num4) - num1);
        System.out.println(Math.abs(Math.max(Math.max(Math.max(num1, num2),num3),num4) - num1));
