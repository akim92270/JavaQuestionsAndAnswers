...
public class ConvertingArrayToList {
    public static void main(String[] args) {
        ...
        System.out.println("\n-------Way-2 of converting Linked to List-------\n");
        ...
        System.out.println("\n-------Way-3 of converting Linked to List-------\n");
        //3rd Way - Manual way

        int[] numbers = {1,2,3,4,5};
        List<Integer> numbersList = new ArrayList<>(); // or ArrayList
        //Collection doesn't work with primitives.
