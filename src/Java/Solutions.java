...
public class Solutions {
    ...
    public static int greatestNumberS1(int a, int b, int c){
        return Math.max(Math.max(a, b), c);
    }

    public static int greatestNumberS2(int a, int b, int c) {
        if(a >= b && a >= c) return a;
        else if(b >= a && b >= c) return b;
        else return c;
    }

    public static int greatestNumberS3(int a, int b, int c) {
        TreeSet<Integer> greatest = new TreeSet<>();
        greatest.add(a);
        greatest.add(b);
        greatest.add(c);
        return greatest.last();
    }

    public static int greatestNumberS4(int a, int b, int c){
        int[] great = {a, b, c};
        Arrays.sort(great);
        return (great.length-1);
    }
    ...
    public static int smallestNumberS1(int a, int b, int c){
        return Math.min(Math.min(a, b), c);
    }

    public static int smallestNumberS2(int a, int b, int c) {
        if (a <= b && a <= c) return a;
        else if (b <= a && b <= c) return b;
        else return c;
    }

    public static int smallestNumberS3(int a, int b, int c){
        int[] s = {a, b, c};
        Arrays.sort(s);
        return s[1];
    }

    public static int smallestNumberS4(int a, int b, int c){
    ...
    public static int middleNumberS1(int a, int b, int c){
        if(a == b || b == c) return b;
    ...
    public static int middleNumberS2(int a, int b, int c){
        int[] m = {a, b, c};
        Arrays.sort(m);
        return (m[1]);
    }

    public static int middleNumberS3(int a, int b, int c){
    ...
    public static String reverseStringS1(String str){
        String s = "";
