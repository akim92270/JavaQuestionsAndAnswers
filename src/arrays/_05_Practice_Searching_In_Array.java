...
public class _05_Practice_Searching_In_Array {
    public static void main(String[] args) {
        ...
        */
         ...
         */
        int[] example4 = {5, -2, 0, -7, 0, 5, 8, 45, 53};
        /*
        ...
        Arrays.sort(example4);

        System.out.println(Arrays.binarySearch(example4,5) >= 0); // true
        System.out.println(Arrays.binarySearch(example4,0) >= 0); // true
        System.out.println(Arrays.binarySearch(example4,45) >= 0); // true
        System.out.println(Arrays.binarySearch(example4,3) >= 0); // f
        System.out.println(Arrays.binarySearch(example4,-7) >= 0); // true
